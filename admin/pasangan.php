                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="sambutan" id="ckeditor" class="ckeditor"> <?= $r['sambutan']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="ket_wanita" id="ckeditor" class="ckeditor"><?= $r['ket_wanita']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="ket_pria" id="ckeditor" class="ckeditor"><?= $r['ket_pria']; ?></textarea>
                                                </div>
                                            </div>
